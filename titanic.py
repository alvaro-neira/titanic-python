...
from TitanicWorker import TitanicWorker
...
def titanic_request (pipe):
    worker = TitanicWorker("tcp://127.0.0.1:5555", "titanic.request")
...
def titanic_reply ():
    worker = TitanicWorker("tcp://127.0.0.1:5555", "titanic.reply")
    reply = None
...
def titanic_close():
    worker = TitanicWorker("tcp://127.0.0.1:5555", "titanic.close")
    reply = None
...
def main():
    ...
    client = TitanicClient("tcp://127.0.0.1:5555", verbose)
